...
export const OH = stytles.hidden;
export const TRANSPARENT = stytles.transparent;
...
export const PABSOLUTE = stytles.pabsolute;
...
export const TAR = stytles.tar;
export const TVC = stytles.tvc;
export const TVT = stytles.tvt;
export const TVB = stytles.tvb;
...
export const AT = (value: number) => {
  return StyleSheet.create({ style: { top: value } }).style;
};
export const AB = (value: number) => {
  return StyleSheet.create({ style: { bottom: value } }).style;
};
export const AL = (value: number) => {
  return StyleSheet.create({ style: { left: value } }).style;
};
export const AR = (value: number) => {
  return StyleSheet.create({ style: { right: value } }).style;
};
