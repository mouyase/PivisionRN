import { type Style, type style as tw } from "twrnc";

type ClassInput = Parameters<typeof tw>[0];

export function parseInputs(inputs: ClassInput[]): [classNames: string[], rnStyles: Style | null] {
